...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-1763121330179-1763121330748.jpg","video":"","title":"단부건 그로쓰세미나","description":"25년차 전문가의 부동산 투자 노하우"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
