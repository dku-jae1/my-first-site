...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"분당시범우성종합상가","period":"2025 - 현재","description":"재건축 추진위원장"},{"icon":"graduation","title":"단국대 부동산건설대학원","period":"2024-현재","description":"도시 및 부동산개발"},{"icon":"award","title":"주요 약력","period":"연세대학교 미래교육원 최고위과정 강사","description":"동국대 미래융합교육원 부동산과정 강사"}],
    skills: [{"icon":"code","title":"작곡가 : 김재일","description":""},{"icon":"database","title":"부동산 전문가","description":"주요 대학 부동산 관련 강사"},{"icon":"palette","title":"저서","description":"실패 없는 부동산 패러다임/\n100세까지 현금 쏟아지는 부동산의 비밀/\n돈 길 따라가는 부동산 투자/\n돈되는 부동산은 따로 있다./\n수도권을 산다."}],
    storyTitle: "나의 이야기",
    story: ["연세대학교 미래교육원 최고위과정 강사","동국대학교 미래융합교육원 부동산과정 강사","경희대학교 평생교육원 부동산과정 강사","부동산 자산관리회수 (주)영율 대표 컨설턴트","TVN 어드바이저(현 키움에셋) 수석연구원","중앙일보, 다음, 베이비뉴스 칼럼니스트","SBS 모닝와이드, OBS 머니투데이 방송 출연","더현대, 스타필드, 롯데백화점 부동산 강사"],
    storyImage: "/uploads/about-image-1763121836224.jpg",
    hobbies: ["부동산","재건축","단부건 35기","교육/강사","🎯 새 취미","🏃 골프"]
  }
